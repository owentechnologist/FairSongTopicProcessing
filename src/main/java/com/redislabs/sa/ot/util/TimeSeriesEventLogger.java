...
public class TimeSeriesEventLogger {
    ...
    JedisPooled jedisPooled = JedisPooledHelper.getJedisPooled();
    ...
    public TimeSeriesEventLogger initTS(){
        ...
        if(null!=customLabel) {
            map.put("uid", customLabel);
        }
        try{
            jedisPooled.ping();
        }catch(Throwable jce){
            jedisPooled = JedisPooledHelper.getJedisPooledFromArgs(startUpArgs);
        }
    ...
    public TimeSeriesEventLogger setJedis(JedisPooled jedis){
        try{
            ...
            this.jedisPooled = JedisPooledHelper.getJedisPooledFromArgs(startUpArgs);
        }
        return this;
    }
    ...
    public TimeSeriesEventLogger setStartupArgs(String[] args){
